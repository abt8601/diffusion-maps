...
public:
  ...
  /**
   * Constructs a vector of size @p size.
   *
  ...
  /**
   * Constructs a vector of size @p size with each element set to @p value.
   *
   * @param size The size of the vector.
  ...
  /**
   * Gets the element at index @p index without bounds checking.
   *
